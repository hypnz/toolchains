...
OUTPUT_ARCH(arm)
ENTRY(_start)
SEARCH_DIR("=/home/vladutadumitroaie21/x-tools/aarch64-unknown-linux-android/aarch64-unknown-linux-android/lib"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib");
SECTIONS
{

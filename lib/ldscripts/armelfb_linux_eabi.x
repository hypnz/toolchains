...
OUTPUT_ARCH(arm)
ENTRY(_start)
SEARCH_DIR("=/home/vladutadumitroaie21/x-tools/arm-cortex_a8-linux-gnueabi/arm-cortex_a8-linux-gnueabi/lib"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib");
SECTIONS
{
